...
type JudgeRequest struct {
	...
	MemoryLimit     int    `form:"memoryLimit" validate:"gte=0,lte=65536" json:"memory_limit,omitempty"` // 内存限制最小为 3000kb, 最大限制为 65536kb
	OutputLimit     int    `form:"outputLimit" validate:"gte=0" json:"output_limit,omitempty"`           // 输出最小限制为 10Byte
